...
public class ModLootTableProvide extends FabricBlockLootTableProvider {
    public ModLootTableProvide(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
...
//        ORES
        ...
        addDrop(ModBlocks.PINK_GARNET_ORE, multipleOreDrops(ModBlocks.PINK_GARNET_ORE, ModItems.RAW_PINK_GARNET, 2, 5));
